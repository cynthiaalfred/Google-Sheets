...
- Grouped data to make it easier to analyse
- Joined cells to combine related information
- Used PROPER to format text correctly (e.g., names)
- Used Find & Replace to fix inconsistent values
